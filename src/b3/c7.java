...
public class c7 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ten mien 1");

        jLabel2.setText("ten mien 2");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txt_ip1))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLabel2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txt_ip2, javax.swing.GroupLayout.PREFERRED_SIZE, 295, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            InetAddress addr1[] = InetAddress.getAllByName(txt_ip1.getText());
            InetAddress addr2[] = InetAddress.getAllByName(txt_ip2.getText());
            if (Arrays.equals(addr1, addr2)) {
                JOptionPane.showMessageDialog(null, "hai ten mien co cung dia chi IP");
            } else {
                JOptionPane.showMessageDialog(null, "hai ten mien 0 cung dia chi IP");
            }
        } catch (Exception e) {
